...
from plots import create_scatter_plot, load_map_data
...
# Load data
    df = load_data('./data/global_development_data.csv')  # Replace with your actual data path
...
with tabs[1]:  # Assuming this is where you want the map
    df = load_data('./data/global_development_data.csv')
